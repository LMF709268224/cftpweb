...
const FieldLabels: Record<string, { zh: string; en: string }> = {
  ...
  from_course_id: { zh: "来源课程版本 ID", en: "source course version ID" },
  from_pipeline_id: { zh: "来源管线版本 ID", en: "source pipeline version ID" },
...
export function localizeApiErrorMessage(
  ...
  if (message === "thumbnail_object_key is invalid: missing SHA256 checksum on S3 object metadata") {
    return "封面对象无效，上传的 S3 元数据缺少 SHA256 哈希"
  }
