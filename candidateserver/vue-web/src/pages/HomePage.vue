...
import { BookOpen, CheckCircle2, Crown, MessageSquare } from "lucide-vue-next"
...
const todoItems = computed(() => unreadCount.value > 0
  ? [{
      id: "message-unread",
...
<template>
  <AppShell>
    <div class="mb-8">
      ...
      <p class="mt-1 text-muted-foreground">{{ t.home.welcomeBack }}，{{ userName }}</p>
    </div>
