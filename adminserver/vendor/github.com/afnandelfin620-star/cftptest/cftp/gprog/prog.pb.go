...
const file_prog_proto_rawDesc = "" +
	...
	"\x19ValidateRetakeEligibility\x12#.gprog.ValidateRetakeEligibilityReq\x1a#.gprog.ValidateRetakeEligibilityRspB\fZ\n" +
...
var file_prog_proto_msgTypes = make([]protoimpl.MessageInfo, 72)
...
var file_prog_proto_depIdxs = []int32{
	...
	5,  // 71: gprog.ProgService.PipelineCreate:output_type -> gprog.PipelineCreateRsp
	7,  // 72: gprog.ProgService.CandidateSignupExam:output_type -> gprog.CandidateSignupExamRsp
	9,  // 73: gprog.ProgService.CandidateApplyRetake:output_type -> gprog.CandidateApplyRetakeRsp
	11, // 74: gprog.ProgService.AdminTerminatePipeline:output_type -> gprog.AdminTerminatePipelineRsp
	13, // 75: gprog.ProgService.AdminForceCourseCompleted:output_type -> gprog.AdminForceCourseCompletedRsp
	15, // 76: gprog.ProgService.AdminForceCourseSignupExam:output_type -> gprog.AdminForceCourseSignupExamRsp
	17, // 77: gprog.ProgService.IgnoreMailTask:output_type -> gprog.IgnoreMailTaskRsp
	19, // 78: gprog.ProgService.ResendMailTask:output_type -> gprog.ResendMailTaskRsp
	21, // 79: gprog.ProgService.ListCandidatePipelines:output_type -> gprog.ListCandidatePipelinesRsp
	24, // 80: gprog.ProgService.GetPipelineDetail:output_type -> gprog.GetPipelineDetailRsp
	30, // 81: gprog.ProgService.GetCourseUnitDetail:output_type -> gprog.GetCourseUnitDetailRsp
	32, // 82: gprog.ProgService.ListStatusTransitionLogs:output_type -> gprog.ListStatusTransitionLogsRsp
	35, // 83: gprog.ProgService.ListMailTasks:output_type -> gprog.ListMailTasksRsp
	38, // 84: gprog.ProgService.GetMailTaskDetail:output_type -> gprog.GetMailTaskDetailRsp
	40, // 85: gprog.ProgService.ListCertificateTasks:output_type -> gprog.ListCertificateTasksRsp
	43, // 86: gprog.ProgService.GetCertificateTaskDetail:output_type -> gprog.GetCertificateTaskDetailRsp
	45, // 87: gprog.ProgService.RetryCertificateTask:output_type -> gprog.RetryCertificateTaskRsp
	47, // 88: gprog.ProgService.AdminTriggerNextStage:output_type -> gprog.AdminTriggerNextStageRsp
	69, // 89: gprog.ProgService.GetExamURL:output_type -> gprog.URLResponse
	71, // 90: gprog.ProgService.ExamUrlCallback:output_type -> gprog.ExamUrlCallbackRsp
	49, // 91: gprog.ProgService.ListPipelines:output_type -> gprog.ListPipelinesRsp
	51, // 92: gprog.ProgService.ListStages:output_type -> gprog.ListStagesRsp
	53, // 93: gprog.ProgService.GetStageDetail:output_type -> gprog.GetStageDetailRsp
	55, // 94: gprog.ProgService.ListCourseUnits:output_type -> gprog.ListCourseUnitsRsp
	58, // 95: gprog.ProgService.ListDriverEvents:output_type -> gprog.ListDriverEventsRsp
	60, // 96: gprog.ProgService.GetDriverEventDetail:output_type -> gprog.GetDriverEventDetailRsp
	63, // 97: gprog.ProgService.ListNatsMessages:output_type -> gprog.ListNatsMessagesRsp
	65, // 98: gprog.ProgService.GetNatsMessageDetail:output_type -> gprog.GetNatsMessageDetailRsp
	67, // 99: gprog.ProgService.GetStatusTransitionLogDetail:output_type -> gprog.GetStatusTransitionLogDetailRsp
	73, // 100: gprog.ProgService.GetPipelineCertificateViewURL:output_type -> gprog.GetPipelineCertificateViewURLRsp
	75, // 101: gprog.ProgService.ValidateRetakeEligibility:output_type -> gprog.ValidateRetakeEligibilityRsp
