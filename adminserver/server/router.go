	...
	r.Route("/api", func(r chi.Router) {
		...
		r.Route("/lms", func(r chi.Router) {
			r.Route("/courses", func(r chi.Router) {
				...
				r.Post("/{course_id}/unpublish", h.UnpublishLmsCourse)
				...
				r.Post("/{course_id}/associations", h.BindLmsCourseAssociation)
				r.Delete("/{course_id}/associations", h.UnbindLmsCourseAssociation)
