...
var candidateRouteContract = []routeExpectation{
	...
	{method: http.MethodPost, path: "/api/pipeline/lessons/{lessonId}/access-url", access: routeProtected},
	...
	{method: http.MethodGet, path: "/api/credentials/applications/{appId}", access: routeProtected},
