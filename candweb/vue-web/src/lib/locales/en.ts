...
export const en: AppTranslations = {
    ...
    learning: {
        ...
        stageExistingOrderResuming: "An unpaid stage order already exists, so its payment is being resumed. Its exemption choices and price are locked; cancel it from Orders first if you need to make changes.",
