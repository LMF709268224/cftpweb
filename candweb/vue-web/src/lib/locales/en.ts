...
export const en: AppTranslations = {
  ...
  checkoutWizard: {
    ...
    viewQualificationApplication: "View qualification application",
    resubmitQualification: "Add qualification materials",
    qualificationUploadReady: "Qualification application created. Opening material upload.",
    ...
    qualificationPaymentDesc: "After payment, you will continue to upload your qualification materials.",
