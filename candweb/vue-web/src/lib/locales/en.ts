...
export const en: AppTranslations = {
    ...
    learning: {
        ...
        stageExemptionDesc: "For every exemptible course in this stage, use an active qualification, apply for qualification review, or waive the exemption and pay full price. An exemption applies only after approval.",
