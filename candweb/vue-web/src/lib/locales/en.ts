...
export const en: AppTranslations = {
  ...
  orders: {
    ...
    detailRawData: "Raw fields returned by current API",
    detailDiscountUnsupported: "The current order detail API does not return historical coupon or discount details yet. Only data already provided by the microservice is shown here.",
    detailProductName: "Product name",
    detailOrderId: "Order ID",
    detailType: "Order type",
    detailBizRef: "Business ref ID",
    detailAmount: "Order amount",
    detailAmountMinor: "Amount (minor unit)",
    detailCurrency: "Currency",
    detailStatus: "Order status",
    detailRawStatus: "Raw status",
    detailPaymentStatus: "Payment status",
    detailCreatedAt: "Created at",
    detailGpayOrderId: "GPay order ID",
    detailPaymentKey: "Payment credential",
    detailPaymentKeyExists: "Returned (redacted)",
    detailPaidAt: "Paid at",
    detailClosedAt: "Closed at",
    detailLastReconciledAt: "Last reconciled at",
    detailOrderStatusAt: "Order status updated at",
    detailPaymentStatusAt: "Payment status updated at",
  ...
  purchaseDialog: {
    ...
    couponHint: "Apply coupon codes to refresh the discount preview. Applied codes will be used when payment starts.",
    couponPlaceholder: "Enter coupon codes, separated by commas or spaces",
    applyCoupon: "Apply coupon",
    clearCoupon: "Clear",
    couponApplied: "Applied discounts",
    couponInvalidTitle: "Coupons not applied",
    couponUnknown: "Unknown coupon",
    couponPreviewFailed: "Failed to preview coupon discounts. Please try again later.",
