...
export const en: AppTranslations = {
    ...
    learning: {
        ...
        stageExemptionDesc: "This stage includes exemptible courses. You can select only courses covered by active qualifications. Leave all unchecked to continue with the full stage payment.",
    ...
    checkoutWizard: {
        ...
        cancelPaymentOrderConfirm: "Cancel this pending order and return to edit your registration? You will need to confirm and create a new order.",
    ...
    credentialsPage: {
        ...
        referenceAttachmentsHint: "Download and review the official templates or examples before preparing your application materials.",
