...
export const en: AppTranslations = {
  common: {
    ...
    purchaseDialogIneligible: "You are not eligible to purchase this certification: ",
    permanent: "Permanent",
  ...
  courses: {
    ...
    pipelineContent: "Certification Flow Content",
  ...
  paymentReturnHandler: {
    ...
    inProgressDesc: "Payment is not complete. Your order is still processing. Please return to My Certifications to continue or recheck the status.",
    unknownDesc: "Payment process returned, but no result was received. Please return to My Certifications to recheck the order status."
  },
  paymentBridge: {
