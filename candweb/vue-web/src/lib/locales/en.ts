...
export const en: AppTranslations = {
    ...
    orders: {
        ...
        pricingTitle: "Price breakdown",
        pricingDescription: "Amounts come from the payment order and its invoice.",
        pricingBillableSubtotal: "Billable list price",
        pricingBillableSubtotalNote: "Subtotal sent to payment after exempted items were removed",
        pricingExemptionDiscount: "Exemption savings",
        pricingExemptionNotRecorded: "Payment orders do not store exemption amounts separately",
        pricingExemptedUnits: "{{count}} approved exemption item(s); amount not stored separately",
        pricingNotRecorded: "Not recorded",
        pricingPromotionDiscount: "Promotion savings",
        pricingPromotionDiscountNote: "Total invoice savings from coupons and promotion codes",
        pricingTax: "Tax",
        pricingTaxNote: "Tax recorded on the payment invoice",
        pricingAmountPaid: "Amount paid",
        pricingAmountPaidNote: "Shows the paid amount when paid, otherwise the amount due",
        pricingUnavailable: "—",
        pricingPartialUnavailable: "Some payment details are temporarily unavailable. Confirmed values are still shown.",
        pricingUnavailableDetail: "No price breakdown is available",
        pricingPromotions: "Applied promotions",
        pricingExemptedItems: "Approved exemptions",
        pricingItemsTitle: "Billable items",
        pricingItem: "Item",
        pricingUnitPrice: "Unit price",
        pricingQuantity: "Quantity",
        pricingSubtotal: "Subtotal",
        pricingUnnamedItem: "Unnamed item",
        pricingSources: {
        ...
        businessFieldLabels: {
            ...
            status_at: "Status updated at",
            pay_mode: "Payment mode",
            pipeline_order_ulid: "Certification order ID",
            pipeline_cc_ulid: "Certification configuration ID",
            instantiated_pipeline_ulid: "Certification instance ID",
            stage_order_ulid: "Stage order ID",
            stage_cc_ulid: "Stage configuration ID",
            stage_ulid: "Stage instance ID",
            stage_pay_order_ulid: "Stage payment order ID",
            course_retake_order_ulid: "Retake order ID",
            course_unit_cc_ulid: "Course unit ID",
            pipeline_unlock_order_ulid: "Certification unlock order ID",
            application_order_ulid: "Qualification application order ID",
            qualification_definition_ulid: "Qualification definition ID",
            bundle_order_ulid: "Certification bundle order ID",
            completed_at: "Completed at",
            completed_reason: "Completion note",
