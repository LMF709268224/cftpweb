export const zh = {
  ...
  learning: {
    ...
    courseTodoDesc: "课程级测验用于完成整门课程的最终检查。",
    todoMaterialsTitle: "1. 学习资料",
    todoLessonsTitle: "2. 课时学习",
    todoQuizzesTitle: "3. 测验",
    allQuizzesTitle: "所有测验",
  ...
  paymentReturnHandler: {
    ...
    failed: "支付失败，请稍后重试。",
    inProgressDesc: "支付尚未完成，订单仍在处理中。请回到我的认证继续支付或重新检查状态。",
    unknownDesc: "支付流程已返回，但没有收到支付结果。请回到我的认证重新检查订单状态。"
  },
  paymentBridge: {
    title: "正在打开支付",
    loading: "支付信息准备中",
  ...
  purchaseDialog: {
    ...
    qualificationUploadNotReady: "资格申请订单已存在，但当前资格申请还没有开放资料上传，请先完成审核费支付或稍后重试。",
