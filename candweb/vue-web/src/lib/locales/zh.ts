export const zh = {
  ...
  orders: {
    ...
    detailRawData: "当前接口返回的原始字段",
    detailDiscountUnsupported: "当前订单详情接口还没有返回历史折扣码或优惠明细；这里先只展示微服务已提供的数据。",
    detailProductName: "商品名称",
    detailOrderId: "订单 ID",
    detailType: "订单类型",
    detailBizRef: "业务关联 ID",
    detailAmount: "订单金额",
    detailAmountMinor: "金额（最小单位）",
    detailCurrency: "币种",
    detailStatus: "订单状态",
    detailRawStatus: "原始状态",
    detailPaymentStatus: "支付状态",
    detailCreatedAt: "创建时间",
    detailGpayOrderId: "GPay 订单 ID",
    detailPaymentKey: "支付凭证",
    detailPaymentKeyExists: "已返回（已脱敏）",
    detailPaidAt: "支付完成时间",
    detailClosedAt: "关闭时间",
    detailLastReconciledAt: "最后对账时间",
    detailOrderStatusAt: "订单状态更新时间",
    detailPaymentStatusAt: "支付状态更新时间",
