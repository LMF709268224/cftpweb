...
export const gfiNavGroups: GfiNavGroup[] = [
  ...
  {
    label: t("专业认证", "Certifications"),
    items: [
      { label: t("专业认证概览", "Overview of Certifications"), to: "/gfi/certifications" },
      { label: t("专业认证路径", "Certification Pathway"), to: "/gfi/certifications/pathway" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: t("个人会员资格", "Individual Membership"), to: "/gfi/membership/benefits" },
...
const common = {
  ...
  network: {
    ...
    text: t("通过专业认证、研究、活动与合作伙伴关系，我们让专业人士能够持续学习并参与行业发展。", "Through certifications, research, events, and partnerships, we enable professionals to keep learning and contribute to the industry's development."),
  },
}
...
export const gfiPages: GfiPageDefinition[] = [
  {
    ...
    image: aboutImage,
    sections: [common.standards, { title: t("影响金融科技教育与标准", "Driving Impact in Fintech Education and Standards"), text: t("自成立以来，GFI通过创建全球认可的专业认证、建立协作网络和引领行业对话，持续推动金融科技知识与实践。", "Since our founding, GFI has advanced fintech knowledge and practice through globally recognised certifications, collaborative networks, and industry dialogue.") }, common.network],
  },
  {
  ...
  },
  {
    ...
    description: t("一支跨学科团队，负责专业认证、研究、合作伙伴关系与全球社群发展。", "A multidisciplinary team advancing certification, research, partnerships, and global community growth."),
    image: aboutImage,
  ...
  },
  {
    ...
    description: t("就专业认证、会员资格、合作伙伴关系、研究或媒体合作联系我们。", "Contact us about certifications, membership, partnerships, research, or media opportunities."),
    image: aboutImage,
  ...
  {
    path: "certifications",
    eyebrow: t("专业认证影响力", "Certifications Impact"),
    title: t("树立全球金融科技标准", "Setting the Global Standard for Fintech"),
    description: t("GFI为横跨金融、技术、监管和创新领域的专业人士提供结构化专业认证路径。", "GFI offers a structured certification pathway for professionals navigating finance, technology, regulation, and innovation."),
    image: certificationImage,
    sections: [{ title: t("特许金融科技助理（CFtA）", "Chartered Fintech Associate (CFtA)"), text: t("为学生、转型人才和职业早期专业人士建立金融科技基础。", "A foundational certification for students, career switchers, and early-career professionals."), bullets: [t("数字金融与新兴技术", "Digital finance and emerging technologies"), t("监管与负责任创新", "Regulation and responsible innovation")] }, { title: t("特许金融科技专业人士（CFtP®）", "Chartered Fintech Professional (CFtP®)"), text: t("面向中高级专业人士的旗舰专业认证，强调高级能力、道德基础和领导准备度。", "GFI's flagship designation for experienced professionals, demonstrating advanced capability, ethical grounding, and leadership readiness.") }, common.standards],
  },
  {
    path: "certifications/pathway",
    eyebrow: t("专业认证路径", "Certification Pathway"),
    title: t("规划您的金融科技职业旅程", "Plan Your Fintech Career Journey"),
    description: t("从基础知识到专业领导力，选择与您的经验和目标相匹配的专业认证。", "Move from foundational knowledge to professional leadership with a certification matched to your experience and goals."),
    image: certificationImage,
  ...
  },
  {
    ...
    description: t("面向职业早期专业人士和金融服务新人的基础金融科技专业认证。全球在线，随时申请。", "A foundational fintech certification for early-career professionals and those new to financial services. Global, online, and open for ongoing applications."),
    image: certificationImage,
    sections: [{ title: t("课程概览", "Programme Overview"), text: t("通过24至30小时的灵活在线学习，系统掌握金融科技基础、数据、人工智能、区块链、网络安全、伦理与治理。", "Build a comprehensive grounding in fintech, data, AI, blockchain, cybersecurity, ethics, and governance through 24-30 hours of flexible online learning."), bullets: [t("全球在线课程", "Global online programme"), t("学习材料已包含", "Learning materials included"), t("基础级认证证书", "Foundational-level certificate")] }, { title: t("适合人群", "Who It's For"), text: t("职业早期专业人士、转行者、金融科技新人、学生和毕业生。", "Early-career professionals, career changers, fintech newcomers, students, and graduates.") }, { title: t("考试与费用", "Exam & Fees"), text: t("在线考试全天候开放，常规总费用为600美元。", "The online exam is available 24/7. Regular total fees are USD 600.") }],
  },
  {
  ...
  },
  {
    ...
    image: ecosystemImage,
    sections: [{ title: t("共同创造行业影响", "Create Industry Impact Together"), text: t("合作形式涵盖专业认证、课程、研究、活动与人才发展。", "Partnerships span certification, education, research, events, and talent development.") }, common.network],
  },
  {
    path: "membership/benefits",
    eyebrow: t("GFI会员资格", "Membership at GFI"),
    title: t("伴随整个职业生涯的专业社群", "A Professional Community for Your Entire Career"),
    description: t("分层会员资格体系支持从探索金融科技的学生到塑造行业未来的资深专业人士。", "Our tiered membership supports everyone from students exploring fintech to senior professionals shaping its future."),
    image: ecosystemImage,
    sections: [{ title: t("附属会员资格 · 每年49美元", "Affiliate Membership · USD 49/year"), text: t("适合学生、职业早期专业人士和转型人才，获得网络研讨会、报告、活动邀请和课程优惠。", "For students, early-career professionals, and career switchers, with access to webinars, reports, events, and course discounts.") }, { title: t("助理会员资格 · 每年129美元", "Associate Membership · USD 129/year"), text: t("适合CFtP考生和CFtA持有者，提供更深入的资源、职业机会和学习优惠。", "For CFtP candidates and CFtA holders, with deeper resources, career opportunities, and enhanced learning benefits.") }, { title: t("特许会员资格 · 每年169美元", "Charterholder Membership · USD 169/year"), text: t("仅限CFtP®持证人，提供最高级别的专业认可、领导机会和行业参与。", "Reserved for CFtP® charterholders, offering the highest level of professional recognition, leadership opportunity, and industry engagement.") }],
  },
  {
