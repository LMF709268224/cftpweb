...
export const contacts = [
  [tx("一般查询", "General Enquiries"), tx("关于GFI、会员资格、活动或使用我们平台的问题。", "Questions about GFI, membership, events or using our platforms."), "info@globalfintechinstitute.org"],
  [tx("专业认证与项目", "Certifications & Programmes"), tx("关于CFtP®、CFtA、专业认证路径、报考资格和报名支持。", "Support for CFtP®, CFtA, certification pathways, eligibility and enrolment."), "cftp@globalfintechinstitute.org"],
