...
export const partnerGroups: Array<{ key: string; title: LocalizedText; description?: LocalizedText; partners: Partner[] }> = [
  {
    ...
    partners: [
      { name: { zh: "新加坡社科大学", en: "Singapore University of Social Sciences" }, logo: `${assetBase}/suss.png`, url: "https://www.suss.edu.sg/", programmes: ["金融学士（BFIN）", "金融硕士（MFIN）", "金融科技硕士（中文）（在读中）"] },
      ...
      { name: { zh: "默多克大学", en: "Murdoch University" }, logo: `${assetBase}/murdoch.png`, url: "https://www.murdoch.edu.au/", programmes: ["银行与金融工商管理学士（双专业）"] },
      ...
      { name: { zh: "博阿齐奇大学", en: "Bogazici University" }, logo: `${assetBase}/bogazici.png`, url: "https://bogazici.edu.tr/en", programmes: ["管理学学士"] },
    ],
  },
  {
    key: "associations",
    ...
    partners: [
      { name: { zh: "WAWEB3", en: "WAWEB3" }, logo: `${assetBase}/waweb3.png`, url: "https://waweb3.org/" },
      { name: { zh: "银行与金融服务工会", en: "Banking and Financial Services Union" }, logo: `${assetBase}/bfsu.jpg`, url: "https://www.bfsu.org.sg/" },
      { name: { zh: "新加坡经济学会", en: "Economic Society of Singapore" }, logo: `${assetBase}/ess.jpg`, url: "https://ess.org.sg/" },
      { name: { zh: "非洲金融科技网络", en: "Africa FinTech Network" }, logo: `${assetBase}/africa.png`, url: "https://africafintechnetwork.com/" },
    ],
  },
  {
    key: "industry",
    ...
    partners: [
      ...
      { name: { zh: "泰坦网络", en: "Titan Network" }, logo: `${assetBase}/titan.png`, url: "https://www.titannet.io/" },
