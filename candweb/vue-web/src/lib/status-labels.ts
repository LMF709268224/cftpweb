...
export const MALL_ORDER_STATUS_LABELS: StatusLabelMap = {
  ...
  "WAIT_STAGE_PAYMENT": "orders.statusWaitPayment",
...
export const CANDIDATE_PIPELINE_STATUS_LABELS: StatusLabelMap = {
  ...
  PIPELINE_STATUS_CANCELLED: "learning.statusCancelled",
}
...
export const CANDIDATE_APPLICATION_STATUS_LABELS: StatusLabelMap = {
  ...
  PENDING: "credentialsPage.appStatusPending",
  Pending: "credentialsPage.appStatusPending",
  APPLICATION_STATUS_PENDING: "credentialsPage.appStatusPending",
  PENDING_UPLOAD: "credentialsPage.appStatusPendingUpload",
  PendingUpload: "credentialsPage.appStatusPendingUpload",
  APPLICATION_STATUS_PENDING_UPLOAD: "credentialsPage.appStatusPendingUpload",
  APPROVED: "credentialsPage.appStatusApproved",
  Approved: "credentialsPage.appStatusApproved",
  APPLICATION_STATUS_APPROVED: "credentialsPage.appStatusApproved",
  REJECTED: "credentialsPage.appStatusRejected",
  Rejected: "credentialsPage.appStatusRejected",
  APPLICATION_STATUS_REJECTED: "credentialsPage.appStatusRejected",
  RESUBMIT: "credentialsPage.appStatusResubmit",
  Resubmit: "credentialsPage.appStatusResubmit",
  REUPLOAD: "credentialsPage.appStatusResubmit",
  Reupload: "credentialsPage.appStatusResubmit",
  NEEDS_RESUBMIT: "credentialsPage.appStatusResubmit",
  APPLICATION_STATUS_RESUBMIT: "credentialsPage.appStatusResubmit",
  APPLICATION_STATUS_REUPLOAD: "credentialsPage.appStatusResubmit",
}
...
export const CANDIDATE_APPLICATION_STATUS_ENUM_NAMES: StatusEnumNameMap = {
  ...
  PENDING_UPLOAD: "APPLICATION_STATUS_PENDING_UPLOAD",
  PendingUpload: "APPLICATION_STATUS_PENDING_UPLOAD",
  APPLICATION_STATUS_PENDING_UPLOAD: "APPLICATION_STATUS_PENDING_UPLOAD",
  APPROVED: "APPLICATION_STATUS_APPROVED",
  Approved: "APPLICATION_STATUS_APPROVED",
  APPLICATION_STATUS_APPROVED: "APPLICATION_STATUS_APPROVED",
  REJECTED: "APPLICATION_STATUS_REJECTED",
  Rejected: "APPLICATION_STATUS_REJECTED",
  APPLICATION_STATUS_REJECTED: "APPLICATION_STATUS_REJECTED",
  RESUBMIT: "APPLICATION_STATUS_RESUBMIT",
  Resubmit: "APPLICATION_STATUS_RESUBMIT",
  REUPLOAD: "APPLICATION_STATUS_REUPLOAD",
  Reupload: "APPLICATION_STATUS_REUPLOAD",
  NEEDS_RESUBMIT: "APPLICATION_STATUS_RESUBMIT",
  APPLICATION_STATUS_RESUBMIT: "APPLICATION_STATUS_RESUBMIT",
  APPLICATION_STATUS_REUPLOAD: "APPLICATION_STATUS_REUPLOAD",
}
