...
const CN_CITY_OPTIONS_BY_STATE: Record<string, string[]> = {
  ...
  HL: ["哈尔滨", "齐齐哈尔", "鸡西", "鹤岗", "˫Ѽɽ", "大庆", "伊春", "佳木斯", "七台河", "牡丹江", "黑河", "绥化", "大兴安岭"],
  ...
  JX: ["南昌", "景德镇", "萍乡", "九江", "新余", "ӥ̶", "赣州", "吉安", "宜春", "抚州", "上饶"],
  ...
  SX: ["̫ԭ", "大同", "阳泉", "长治", "晋城", "朔州", "晋中", "运城", "忻州", "临汾", "吕梁"],
  SC: ["成都", "自贡", "攀枝花", "泸州", "德阳", "绵阳", "广元", "遂宁", "内江", "乐山", "南充", "üɽ", "宜宾", "广安", "达州", "雅安", "巴中", "资阳", "阿坝", "甘孜", "凉山"],
