...
function passStatusValue(exam: any) {
  if (shouldUseCurrentCourseUnitState(exam)) return null
              ...
              <div class="min-w-0 space-y-2 pl-1">
                <div class="flex flex-wrap items-center gap-2">
                  ...
                  <template v-else>
                    ...
                    <span v-else-if="hasExamResult(exam) && !hasExplicitPassStatus(exam)" :class="['badge', examStatusBadgeClass('DONE')]">{{ resultPublishedLabel() }}</span>
