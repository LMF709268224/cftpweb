  ...
  <div class="ecosystem-page">
    ...
    <main v-else-if="isPartnerships" class="partnership-page">
      ...
      <section id="our-partners" class="partner-directory section-container">
        ...
        <section class="patron-block" data-reveal><h3>Silver Corporate Patron</h3><p>2026 Silver Corporate Patron</p><a class="patron-card" href="https://uqpay.com" target="_blank" rel="noopener noreferrer"><div class="logo-frame"><img src="/gfi/ecosystem/uqpay.png" alt="UQPay"></div><div class="partner-copy"><strong>UQPay</strong></div></a></section>
